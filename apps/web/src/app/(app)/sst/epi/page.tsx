        ...
        <Card>
          ...
          >
            ...
            <label className="flex flex-col gap-1.5 text-sm">
              ...
              <input value={item} onChange={(e) => setItem(e.target.value)} placeholder="Capacete, luva, protetor auditivo…" required className="rounded-control border border-border-strong bg-surface px-3 py-2" />
            </label>
            <label className="flex flex-col gap-1.5 text-sm">
